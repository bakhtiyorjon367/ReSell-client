...
import { sweetConfirmAlert, sweetErrorHandling, sweetMixinSuccessAlert, sweetTopSmallSuccessAlert, sweetTopSuccessAlert } from '../../sweetAlert';
...
const MyProfile: NextPage = ({ initialValues, ...props }: any) => {
	...
	const updateProductHandler = useCallback(async () => {
		try {
			...
			await sweetTopSuccessAlert("Profile Updated");
		}catch(err:any){
