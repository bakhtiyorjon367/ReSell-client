...
const WomenFashion= (props:WomenFashionProps) => {
    const { t, i18n } = useTranslation('common');
    const { initialInput } = props;
    const [products, setProducts] = useState<Product[]>([]);
    /** APOLLO REQUESTS **/
    const{ 
        loading:getWomenFashionLoading,
        data:getWomenFashionData, 
        error:getWomenFashionError, 
        refetch:getWomenFashionRefetch
...
WomenFashion.defaultProps = {
    initialInput: {
        page:1,
        limit:8,
        sort:'createdAt',
        search:{
            typeList:[ProductCategory.WOMEN]
        },
    },
};
